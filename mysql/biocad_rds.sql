...
START TRANSACTION;
USE `biocad_rds`;
INSERT INTO `analysis_app` (`id`, `name`, `description`, `app_path`, `project_type`, `version`) VALUES (1, 'Systems_Dynamics', 'PLAS.NET similator', '/opt/biocad/webR/PLAS.R', 0, '1.0');
